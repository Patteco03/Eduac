<div class="wrapper">
	...
	<div class="centro-form">
		...
		<div class="co" style="z-index:9;">
			<a href="<?php echo site_url('conta/recuperarsenha') ?>" > Esqueci minha senha</a>
		</div>
		</form>
	...
	<br><br><br>
	<div class="col-md-12" style="z-index: 9;"> <center> Não é cadastrado ? <a href="<?php echo site_url('conta/novaconta') ?>"> Cadastrar </a> </center></div>
